...
int main(void) {
  ...
  /* AFE power up */ // This part is failing - because I had the crystal around the wrong way? 
  ...
  while (sweeping) /* this outerloop just keeps running through the multifrequency sweep. */
  {
    ...
    //  while (running) {
      ...
      }  /*end of single frequency run */
      
      
    } /*  end of multifrequency loop */ 
