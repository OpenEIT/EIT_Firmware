...
#include  "musbhdrc/usbd_bsp_musbhdrc.c"

#elif defined(__ADSPBF609_FAMILY__) || defined(__ADSPBF707_FAMILY__)

#include  "musbmhdrc/usbd_bsp_blackfin.c"

#elif defined(__ADSPSC589_FAMILY__)

#include  "musbmhdrc/usbd_bsp_musbmhdrc.c"

#elif defined(ADI_ADUCM350)

#include  "musbmhdrc/usbd_bsp_aducm350.c"
...
#include  "net2272/usbd_bsp_net2272.c"
